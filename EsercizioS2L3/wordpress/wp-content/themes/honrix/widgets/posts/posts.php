                    ...
                    while ($the_query->have_posts()) :
                        ...
                        <article class="d-flex flex-column">
                            ...
                            <div class="entry-body mt-auto">
                                ...
                                <?php if (is_sticky()) : ?>
                                    <?php
                                    the_title(sprintf('<h2 class="entry-title mb-2 fs-4 d-flex align-items-center gap-2"><span class="fas fa-thumbtack"></span><a href="%s" rel="bookmark">', esc_url(get_permalink())), '</a></h2>');
                                    ?>
                                <?php else : ?>
                                    <?php the_title(sprintf('<h2 class="entry-title mb-2 fs-4"><a href="%s" rel="bookmark">', esc_url(get_permalink())), '</a></h2>'); ?>
                                <?php endif; ?>
                                <?php
                                ...
                                <div class="entry-read-more mb-2 pb-3">
                                ...
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-6 d-flex align-items-center justify-content-end">
                                        <span class="date"><i class="far fa-calendar me-1"></i><small><?php the_date(); ?></small></span>
